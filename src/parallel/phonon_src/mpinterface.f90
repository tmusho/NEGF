...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine Mpinterface_Write_Header(Lb,Lw,Lc,Nl,mat1,mat2,Lg,Lg_o,Tp,dT,debug_l,an_ph_si,ab_si,am_ph_ge,ab_ge,ms_ph_si,mg_ph_ge,v_si,v_ge)

   integer(kind=4), intent(inout) :: debug_l
   integer(kind=4), intent(in) :: mat1,mat2,Nl,Lg_o,ab_si,ab_ge
   real(kind=8), intent(in) :: Lb,Lw,Lc,Tp,Lg,dT,an_ph_si,am_ph_ge,ms_ph_si,mg_ph_ge,v_si,v_ge

   write(6,*)
   write(6,*)'+++ Coupled Run; Sending Header Data to NEGF Phonon +++'

   open(UnitCouple,file='elements.bin',form='unformatted')
   write(UnitCouple)Lb,Lw,Lc,Nl,mat1,mat2,Lg,Lg_o,Tp,dT,debug_l,an_ph_si,ab_si,am_ph_ge,ab_ge,ms_ph_si,mg_ph_ge,v_si,v_ge
   close(UnitCouple)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine Mpinterface_Read_Header(Lb,Lw,Lc,Nl,mat1,mat2,Lg,Lg_o,Tp,dT,debug_l,an,ab_s,am,ab_g,ms,mg,vsi,vge)

   integer(kind=4), intent(inout) :: debug_l
   integer(kind=4), intent(out) :: mat1,mat2,Nl,Lg_o,ab_s,ab_g
   real(kind=8), intent(out) :: Lb,Lw,Lc,Tp,Lg,dT,an,am,ms,mg,vsi,vge
   ...
   open(UnitCouple,file='elements.bin',form='unformatted')
   read(UnitCouple)Lb,Lw,Lc,Nl,mat1,mat2,Lg,Lg_o,Tp,dT,debug_l,an,ab_s,am,ab_g,ms,mg,vsi,vge
