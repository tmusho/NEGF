...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! Matxopt_sub_zvtf3 - Add vector to tridiagonal
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine Matxopt_sub_zvtf3(VV,TT,ns)
...
end subroutine Matxopt_sub_zvtf3
...
!complex acos, get NaNs if use intrinsic function
complex function acos_log(z)
     complex(8), intent(in) :: z
     complex(8), parameter :: i = (0.0,1.0)
     complex(8), parameter :: pi = (3.14159265,0.0)
     if(z .ne. 0.0) then
       acos_log = -i*dclog(z+i*dcsqrt(1-z**2))
     else
       acos_log = pi/2.0
     end if
end function acos_log

!dcsqrt - complex square root
complex function dcsqrt(z)
     complex(8), intent(in) :: z
     complex(8), parameter :: i = (0.0,1.0)
     dcsqrt = dcmplx(1/sqrt(2.0)*dsqrt(dsqrt(real(z)**2+aimag(z)**2)+real(z)),&
     (aimag(z)/abs(aimag(z)))/sqrt(2.0)*dsqrt(dsqrt(real(z)**2+aimag(z)**2)-real(z)))
end function dcsqrt

!dclog - complex natural log
complex function dclog(z)
     complex(8), intent(in) :: z
     complex(8), parameter :: i = (0.0,1.0)
     dclog = dcmplx(dlog(sqrt(real(z)**2+aimag(z)**2)),dlog(atan(aimag(z)/real(z))))
end function dclog
